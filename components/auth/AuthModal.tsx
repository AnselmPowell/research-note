        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {isSignUp && (
            <div>
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-scholar-500 dark:focus:ring-scholar-400 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors ${formErrors.name ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-800' : 'border-gray-200 dark:border-gray-700'
                  }`}
                disabled={isLoading}
                required
              />
          ...
          <div>
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-scholar-500 dark:focus:ring-scholar-400 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors ${formErrors.email ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-800' : 'border-gray-200 dark:border-gray-700'
                }`}
              disabled={isLoading}
              required
            />
          ...
          <div>
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-scholar-500 dark:focus:ring-scholar-400 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors ${formErrors.password ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-800' : 'border-gray-200 dark:border-gray-700'
                }`}
              disabled={isLoading}
              required
              minLength={6}
          ...
          {isSignUp && (
            <div>
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-scholar-500 dark:focus:ring-scholar-400 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors ${formErrors.confirmPassword ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-800' : 'border-gray-200 dark:border-gray-700'
                  }`}
                disabled={isLoading}
                required
              />
